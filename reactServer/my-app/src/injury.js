...
import TeamInjury from "./injury/teamInjury";
import { keyInjuries, pages, teams } from "./utils";
import Ads from "./fixtures/ads";
import FixtureHeader from "./fixtures/fixtureHeader";

export default function InjuryNews () {
