...
export default function Clubs() {
    return (
        <main >
            <Ads/>
            <FixtureHeader container={ pages.clubs.header }/>
            <div className="fixtures-contents">
                <PageFiltersSection container={pages.clubs}/>
                <section className="table-wrapper">
                    <h3 className="section-title">All-time Premier League Clubs</h3>
                    <table className="standing-big clubs">
                        <thead>
                            <tr>
                                <th>Club</th>
                                <th>Stadium</th>
                                        ...
                                        <tr>
                                            <td className="club">
                                                <div className="club-cont">
                                                    <div className="club-img-cont">
                                                        <img src={team.image_url} alt={`${teams[0].name}-logo`} />
                                                    </div>
                                            ...
                                            <td className="stadium-cell">
                                                <div className="venue-container">
                                                    <svg xmlns="http://www.w3.org/2000/svg"  fill="#000000" version="1.1" id="Capa_1" viewBox="0 0 415.506 415.506" >
